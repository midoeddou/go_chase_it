...
//Publish requested linear x and angular velocities to robot wheel joints
...
ROS_INFO("DriveToTargetRequest received - linear_x:%1.2f, angular_z:%1.2f", (float)req.linear_x, (float)req.angular_z);

     {
        ...
        // Set wheel velocities, toward ball
...
int main(int argc, char** argv)
{
    ...
    ros::ServiceServer service = n.advertiseService("/drive_bot/DriveToTarget",handle_drive_request);
